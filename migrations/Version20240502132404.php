 ...
 */
final class Version20240502132404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE analyse CHANGE nom nom VARCHAR(25) DEFAULT NULL, CHANGE type type VARCHAR(35) DEFAULT NULL, CHANGE date date DATE DEFAULT NULL');
